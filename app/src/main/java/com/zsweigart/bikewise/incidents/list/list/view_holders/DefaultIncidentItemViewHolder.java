 ...
 */
public class DefaultIncidentItemViewHolder extends RecyclerView.ViewHolder {

    private TextView titleView;
    private TextView descriptionView;

    public DefaultIncidentItemViewHolder(View itemView) {
        super(itemView);

        titleView = itemView.findViewById(R.id.default_layout_title);
        descriptionView = itemView.findViewById(R.id.default_layout_description);
    }

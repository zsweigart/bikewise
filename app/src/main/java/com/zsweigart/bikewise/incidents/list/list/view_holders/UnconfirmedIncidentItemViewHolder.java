 ...
 */
public class UnconfirmedIncidentItemViewHolder  extends RecyclerView.ViewHolder {

    private TextView titleView;
    private TextView descriptionView;

    public UnconfirmedIncidentItemViewHolder(View itemView) {
        super(itemView);

        titleView = itemView.findViewById(R.id.unconfirmed_layout_title);
        descriptionView = itemView.findViewById(R.id.unconfirmed_layout_description);
    }

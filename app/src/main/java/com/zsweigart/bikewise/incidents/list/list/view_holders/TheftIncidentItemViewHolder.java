 ...
 */
public class TheftIncidentItemViewHolder  extends RecyclerView.ViewHolder {

    private TextView titleView;
    private TextView descriptionView;

    public TheftIncidentItemViewHolder(View itemView) {
        super(itemView);

        titleView = itemView.findViewById(R.id.theft_layout_title);
        descriptionView = itemView.findViewById(R.id.theft_layout_description);
    }
